//! Bevy ECS vs `jeod_runner::Simulation` parity for the
...
fn assert_topology_match(
    ...
    r_v2: usize,
    r_v3: usize,
    id_v1: jeod_sim::MassBodyId,
    id_v2: jeod_sim::MassBodyId,
    id_v3: jeod_sim::MassBodyId,
    label: &str,
) {
    ...
    let pairs: [(&str, Entity, usize, jeod_sim::MassBodyId); 3] = [
        ("v1", b_v1, r_v1, id_v1),
        ("v2", b_v2, r_v2, id_v2),
        ("v3", b_v3, r_v3, id_v3),
    ];
...
fn bevy_sim_elapsed(app: &App) -> f64 {
    app.world()
        .resource::<bevy_jeod::SimulationTimeR>()
        .0
        .simtime
}
