...
fn tier3_bevy_solar_beta_equ() {
    ...
    let vehicle = app
        .world_mut()
        .spawn((
            TranslationalStateC::<jeod_sim::Earth>::from(equ_trans),
...
fn tier3_bevy_solar_beta_obliquity() {
    ...
    let vehicle = app
        .world_mut()
        .spawn((
            TranslationalStateC::<jeod_sim::Earth>::from(obl_trans),
            DynamicsConfigC::default(),
            GravityControlsC(GravityControls {
                controls: vec![GravityControl::new_spherical(planet, false)],
            }),
...
fn tier3_bevy_mars_dawn() {
    ...
    let vehicle = app
        .world_mut()
        .spawn((
            TranslationalStateC::<jeod_sim::Earth>::from(mars_trans),
            DynamicsConfigC::default(),
            GravityControlsC(GravityControls {
...
fn tier3_bevy_mercury_relativistic() {
    ...
    let vehicle = app
        .world_mut()
        .spawn((
            TranslationalStateC::<jeod_sim::Earth>::from(mercury_trans),
            DynamicsConfigC::default(),
            GravityControlsC(GravityControls {
...
fn tier3_bevy_earth_moon_clem() {
    ...
    let vehicle = app
        .world_mut()
        .spawn((
            TranslationalStateC::<jeod_sim::Earth>::from(clem_trans),
