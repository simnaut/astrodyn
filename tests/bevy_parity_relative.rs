...
fn run_relative_parity(
    ...
    let bevy_rel = jeod_sim::compute_relative_state::<jeod_sim::SelfRef, jeod_sim::SelfRef>(
        &bevy_a.trans,
        Some(&bevy_a.rot),
        &bevy_b.trans,
        Some(&bevy_b.rot),
    ...
    let sim_rel = jeod_sim::compute_relative_state::<jeod_sim::SelfRef, jeod_sim::SelfRef>(
        &sim_a_state.trans,
