...
use astrodyn_interactions::earth_lighting::calc_lighting_params;
use std::path::Path;
...
fn test_data_path(filename: &str) -> std::path::PathBuf {
    // Lighting CSVs are JEOD-trick reference data; they live with the
    // tier-3 fixtures under crates/astrodyn_verif_jeod/test_data/.
