...
//! feeds into `astrodyn_time::SimulationTime` at sim startup.
...
mod tests {
    ...
    fn test_parse_dyncomp_time() {
        let content = r#"
astrodyn_time.time_manager_init.initializer = "UTC"
astrodyn_time.time_manager_init.sim_start_format = trick.TimeEnum.calendar
astrodyn_time.time_utc.set_date_and_time(2007, 11, 20, 0, 0, 0.0)

astrodyn_time.time_tai.initialize_from_name = "UTC"
astrodyn_time.time_ut1.initialize_from_name = "TAI"

astrodyn_time.time_converter_tai_utc.override_data_table = True
astrodyn_time.time_converter_tai_utc.leap_sec_override_val = 32

astrodyn_time.time_converter_tai_ut1.override_data_table = True
astrodyn_time.time_converter_tai_ut1.tai_to_ut1_override_val = -32.469
"#;
    ...
    fn test_parse_apollo_time_with_expression() {
        let content = r#"
astrodyn_time.time_utc.set_date_and_time(1969, 7, 16, 13, 44, 0.0)
astrodyn_time.time_converter_tai_utc.override_data_table = True
astrodyn_time.time_converter_tai_utc.leap_sec_override_val = 4.2
astrodyn_time.time_converter_tai_ut1.override_data_table = True
astrodyn_time.time_converter_tai_ut1.tai_to_ut1_override_val = 0.0115221 - 4.2
"#;
        let cfg = parse_time_config_str(content, &PathBuf::from("test"));
    ...
    fn test_parse_tai_initialized_time() {
        ...
        let content = r#"
astrodyn_time.time_manager_init.initializer = "TAI"
astrodyn_time.time_manager_init.sim_start_format = trick.TimeEnum.calendar
astrodyn_time.time_tai.set_date_and_time(1998, 12, 1, 0, 0, 31.0)
astrodyn_time.time_tai.update_from_name = "Dyn"
astrodyn_time.time_tt.initialize_from_name = "TAI"
astrodyn_time.time_tt.update_from_name = "TAI"
"#;
        let cfg = parse_time_config_str(content, &PathBuf::from("test"));
...
astrodyn_time.time_manager_init.initializer = "UTC"
astrodyn_time.time_manager_init.sim_start_format = trick.TimeEnum.calendar
astrodyn_time.time_utc.set_date_and_time(1991, 1, 1, 0, 0, 0.0)
astrodyn_time.time_tai.initialize_from_name = "UTC"
astrodyn_time.time_ut1.initialize_from_name = "TAI"
"#;
        let cfg = parse_time_config_str(content, &PathBuf::from("test"));
