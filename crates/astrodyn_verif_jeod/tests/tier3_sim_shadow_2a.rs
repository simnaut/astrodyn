...
const R_EARTH: f64 = astrodyn::EARTH.shadow_radius;
...
fn run_shadow_comparison(csv_filename: &str, label: &str, test_name: &str, frac_tol: f64) {
    ...
    let time = SimulationTime::new(epoch_tjt, astrodyn::default_leap_second_table());
    ...
    let sun = sim.add_source(
        ...
        GravitySourceEntry {
            ...
            position: astrodyn::Vec3Ext::m_at::<astrodyn::RootInertial>(initial_sun),
            velocity: astrodyn::Velocity::<astrodyn::RootInertial>::zero(),
            t_inertial_pfix: None,
            delta_c20: 0.0,
            rotation_model: RotationModel::default(),
