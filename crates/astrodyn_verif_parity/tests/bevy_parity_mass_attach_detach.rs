...
//! `crates/astrodyn_dynamics/tests/tier3_mass_attach_detach.rs` to a
//! Bevy-adapter parity test that exercises the new
//! [`astrodyn_bevy::MassChildOf`] relation and
//! [`astrodyn_bevy::composite_mass_system`].
//!
//! For every scenario:
//!
...
//! delegates to the storage-agnostic `astrodyn::MassStorage` kernel,
...
use astrodyn_bevy::{
    composite_mass_system, AttachEvent, MassBodyIdC, MassChildOf, MassPropertiesC,
};
use bevy::prelude::*;
...
fn bevy_staging_system_does_not_corrupt_composite_core_cache() {
    ...
    app.add_systems(
        ...
        (
            ...
            astrodyn_bevy::staging_system::<astrodyn::Earth>.after(composite_mass_system),
        ),
    );
