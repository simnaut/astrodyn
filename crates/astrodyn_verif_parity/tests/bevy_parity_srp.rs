...
fn tier3_bevy_full_stack_sixdof() {
    ...
    let vehicle = app
        ...
        .spawn((
            ...
            FlatPlateConfigC(astrodyn::FlatPlateState {
    ...
    body.srp = Some(SrpModel::FlatPlate(astrodyn::FlatPlateState {
        plates: srp_plates,
        temperatures: vec![270.0],
        t_pow4_cached: vec![270.0_f64.powi(4)],
        ..Default::default()
...
fn tier3_bevy_flat_plate_srp_with_shadow() {
    ...
    let planet = app
        ...
        .spawn((
            ...
            TranslationalStateC::<astrodyn::Earth>::default(),
            ShadowBodyC {
                radius: astrodyn::planet_config::EARTH.shadow_radius,
            },
        ))
        .id();
    ...
    sim.add_body(VehicleConfig {
        ...
        srp: Some(SrpModel::FlatPlate(astrodyn::FlatPlateState {
            plates: plates_data,
            temperatures: vec![init_temp; num_plates],
            t_pow4_cached: vec![init_temp.powi(4); num_plates],
            ..Default::default()
...
fn run_srp_deriv_parity(
    label: &str,
    order: astrodyn::ThermalIntegrationOrder,
    srp_plates: Vec<(
        FlatPlate<astrodyn::SelfRef>,
        FlatPlateParams,
        FlatPlateThermal,
...
fn tier3_bevy_srp_derivative_rk4_with_rotated_struct_frame() {
    ...
    let sun_pos = DVec3::new(1.496e11, 0.0, 0.0);
    let order = astrodyn::ThermalIntegrationOrder::DerivativeRk4;
    ...
    let vehicle = app
        ...
        .spawn((
            ...
            StructuralTransformC(astrodyn::FrameTransform::from_matrix(t_struct_body)),
            FlatPlateConfigC(astrodyn::FlatPlateState {
