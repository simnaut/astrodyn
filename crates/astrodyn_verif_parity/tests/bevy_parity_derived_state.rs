...
fn tier3_bevy_derived_states() {
    ...
    assert_orbital_elements_eq(
        "Bevy vs Sim OE",
        &bevy_oe,
        &sim_oe.clone().relabel::<astrodyn::Earth>(),
    );
...
fn tier3_bevy_eccentric_derived_states() {
    ...
    sim.add_body(VehicleConfig {
        trans: astrodyn_bevy::typed_bridge::trans_raw_to_root(&ecc_trans),
...
fn tier3_bevy_polar_geodetic() {
    ...
    sim.add_body(VehicleConfig {
        trans: astrodyn_bevy::typed_bridge::trans_raw_to_root(&polar_trans),
        gravity_controls: GravityControls {
            controls: vec![GravityControl::new_spherical(earth_idx, false)],
        },
        derived: DerivedStateConfig {
...
fn tier3_bevy_solar_beta() {
    ...
    sim.add_body(VehicleConfig {
        trans: astrodyn_bevy::typed_bridge::trans_raw_to_root(&inc_trans),
        gravity_controls: GravityControls {
            controls: vec![GravityControl::new_spherical(earth_idx, false)],
        },
        derived: DerivedStateConfig {
