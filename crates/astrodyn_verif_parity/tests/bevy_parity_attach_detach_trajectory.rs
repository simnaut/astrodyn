...
//! Bevy ECS vs `astrodyn_runner::Simulation` parity for the SIM_verif_
//! attach_detach RUN_simple_attach_detach scenario, driven through the
//! production `AttachEvent` surface end-to-end.
//!
//! Companion to `crates/astrodyn_runner/tests/tier3_sim_attach_detach_
...
//! `astrodyn` drives the pipeline up to the detach event.
//!
