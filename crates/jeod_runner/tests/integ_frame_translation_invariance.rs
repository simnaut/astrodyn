...
fn earth_at_offset(mu: f64) -> GravitySourceEntry {
    GravitySourceEntry {
        ...
        position: jeod_sim::Position::<jeod_sim::RootInertial>::from_raw_si(SSB_TO_EARTH_OFFSET),
        velocity: jeod_sim::Velocity::<jeod_sim::RootInertial>::zero(),
        t_inertial_pfix: Some(glam::DMat3::IDENTITY),
        rotation_model: RotationModel::None,
        delta_c20: 0.0,
...
fn sun_source(position_in_root: DVec3) -> GravitySourceEntry {
    GravitySourceEntry {
        ...
        position: jeod_sim::Position::<jeod_sim::RootInertial>::from_raw_si(position_in_root),
        velocity: jeod_sim::Velocity::<jeod_sim::RootInertial>::zero(),
        t_inertial_pfix: None,
        rotation_model: RotationModel::None,
        delta_c20: 0.0,
...
fn body_config(integ_source: Option<usize>, gravity_source_idx: usize) -> VehicleConfig {
    ...
    cfg.derived.geodetic = Some(jeod_sim::GeodeticConfig {
