//! Property-based round-trip tests for `astrodyn_quantities` algebraic laws.
//!
//! Three suites:
...
fn arbitrary_position<F: Frame>() -> impl Strategy<Value = astrodyn_quantities::aliases::Position<F>>
{
